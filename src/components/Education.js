...
function Education(){
    return(
        <div id="education" style={{backgroundColor:'#213642'}}>
            <h1 style={{textAlign:'center', color:'white'}}>Education:</h1>
            <div className="education-container d-flex flex-column flex-md-row" style={{height:'auto', width:'100%', backgroundColor:'#213642'}}>
